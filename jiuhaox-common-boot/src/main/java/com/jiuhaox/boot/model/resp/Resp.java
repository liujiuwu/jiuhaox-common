package com.jiuhaox.boot.model.resp;

import cn.hutool.core.util.StrUtil;
import com.fasterxml.jackson.annotation.JsonIgnore;
import com.fasterxml.jackson.annotation.JsonInclude;
import com.jiuhaox.boot.exceptions.AppErrorCode;
import com.jiuhaox.boot.enums.RespStatus;
import com.jiuhaox.boot.exceptions.ErrorCode;

import java.beans.Transient;
import java.util.function.BiConsumer;
import java.util.function.Consumer;

import static com.jiuhaox.boot.enums.RespStatus.FAIL;
import static com.jiuhaox.boot.enums.RespStatus.SUCC;
